...
const DonorProfile = () => {
  ...
  const handleChange = (e: React.ChangeEvent<HTMLInputElement | HTMLSelectElement | HTMLTextAreaElement>) => {
    setProfile({ ...profile, [e.target.name]: e.target.value } as DonorProfileDto);
  };
  ...
  async function handleSave(e: React.FormEvent) {
    ...
    try {
      ...
      setMessage((err as import("axios").AxiosError<{message: string}>).response?.data?.message || 'Failed to update profile?.');
    } finally {
      setSaving(false);
    }
  };
